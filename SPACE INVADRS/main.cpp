...
int main(){
    ...
    MIDI *musica_fondo = load_midi("Recursos/spaceinvaders1.midi");

    play_midi(musica_fondo,1); //1 PARA QUE SUENE TODO EL TIEMPO 0 PARA ESCUCHARLO UN TIEMPO
    PORTADA(portada);

    NAVE N;
    N.inicia("Recursos/nave.bmp", "Recursos/Bala2.bmp", 6,12,30,20, ANCHO/2, ALTO-70 ,-8,0, 3,"Recursos/0.wav","Recursos/explosion.wav" );
    NAVE E[60];
    acomoda_enemigo(E);
